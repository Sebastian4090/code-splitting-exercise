...
class App extends Component {
  ...
  render() {
    ...
    if (this.state.route === 'page1') {
      ...
      return <Suspense fallback={<div>Loading...</div>}><Page2 onRouteChange={this.onRouteChange} /></Suspense>
    } else {
      return <Suspense fallback={<div>Loading...</div>}><Page3 onRouteChange={this.onRouteChange} /></Suspense>
    }
